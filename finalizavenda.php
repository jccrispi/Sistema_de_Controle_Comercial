...
if(!$qtdeprod && !$qtdeserv){
	echo  "<h2><center>NÃO FORAM SELECIONADOS PRODUTOS OU SERVIÇOS!</center></h2>";
	echo "<a href='form_vendamercad.php' target='principal'><h2>Voltar</h2></a>";
}
else
{

	echo '<h2><center>VENDA REALIZADA COM SUCESSO!</center></h2>';
...
if($qtdeserv){			
			...
			echo '<td bgcolor="#E0DFEE"><center>R$ ' . $item['precserv'] . '</td>';
			...
			echo '<tr>';
			echo '<td bgcolor="#E0DFEE"><h2>VALOR TOTAL DA VENDA</h2></td>';
